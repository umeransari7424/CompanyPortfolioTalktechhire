    ...
    <div className="contactus">
      <div className="container-fluid text-center py-5 mt-5">
            ...
            <div className="card card1 p-4 ">
              <div className="d-flex justify-content-between contact-detail">
                <div>
                  <div className="d-flex gap-4 ">
                    <div className="rocket">
                      <FaLocationDot size={"60px"} className="rocicon" />
                    </div>
                  <div>
                    <div>
                      <h2> Address</h2>
                ...
                <div>
                  <div className="d-flex  gap-4">
                    <div className="rocket">
                      <BsFillTelephoneFill size={"60px"} className="rocicon" />
                    </div>
                  <div>
                    <div>
                      <h2>Phone</h2>
                ...
                <div>
                  <div className="d-flex  gap-4">
                    <div className="rocket">
                      <BiLogoGmail size={"60px"} className="rocicon " />
                    </div>
                  <div>
                    <div>
                      <h2>E-Mail</h2>
        ...
        <div className="row contact-row">
          ...
          <div className="col-md-7 pt-5 text-start">
            {/* <div className=" p-4"> */}
            <div className="form-container ">
              <div className="form">
                <span className="heading pb-4">Get in touch</span>
                ...
                <div className="flex-container">
                  ...
                  <div className="flex-item">
                    <input placeholder="Your Subject" type="text" className="input" />
                  </div>
                </div>
